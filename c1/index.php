...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <div class="w-1/4 bg-gradient-to-b from-red-800 to-red-600 text-white p-6">
            <div class="flex items-center mb-8">
                <img src="parfumred.jpeg" alt="Profile picture" class="rounded-full w-12 h-12 mr-4"/>
    ...
    <img src="parfumred.jpeg" alt="Foto Profil" class="w-100 h-100 object-cover border border-gray-300 shadow-lg">
</div>
