...
<head>
    ...
    <style>
        body {
            background: url('merah.jpeg') no-repeat center center fixed;
        ...
        <form class="space-y-4" action="proses_login.php" method="POST">
            <div class="relative">
                <input type="text" name="username" placeholder="Username" required
                       class="w-full px-4 py-3 pl-10 rounded-full bg-white bg-opacity-30 text-white placeholder-gray-200 focus:ring-2 focus:ring-red-400 focus:outline-none"/>
